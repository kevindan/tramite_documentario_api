	...
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<h1>
					Registro de Documentos <small>Ingresar documentos</small>
				</h1>
				</section>
			</div>
		</div>
			  ...
			  <div class="panel-body">
				<form role="form" name="formDocente">
						...
						<div class="col-md-2">
							<div class="form-group">
								<label>Cod. Registro : </label> <input type="text"
									class="form-control" id="codigo_registro" name="txtcodregistro"
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label>Documento : </label> <select class="form-control" id="codigo_tipo_documento"
						...
						<div class="col-md-3">
							<div class="form-group">
								<label>Nro Documento : </label> <input type="text"
									class="form-control" id="numero_documento" name="txtnumerodocumento"
					...
					<div class="row">
					  <div class="col-md-4">
						<div class="form-group">
                  			<label for="exampleInputFile">Seleccione archivo PDF</label>
					...
					<div class="row">	
						<div class="col-md-4">
							<div class="form-group">
								<label>Unidad de origen : </label> <select class="form-control"
									id="cod_unidad_origen" name="cbounidadorigen">
									<option>Seleccione</option>
						...
						<div class="col-md-2">
							<div class="form-group">
								<label>Clasifcacion : </label> <select class="form-control" id="cod_clasificacion"
